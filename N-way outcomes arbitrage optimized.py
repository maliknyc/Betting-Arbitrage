...
# [NOT USED] Recalculate American odds without betting vigorish
...
# [NOT USED] Confirm vigorish odds add up to implied probability of 100
...
# Create list of decimal odds from list of American odds
...
# Calls arb_identifier_new to identify whether there's an arbitrage opportunity, and runs 
